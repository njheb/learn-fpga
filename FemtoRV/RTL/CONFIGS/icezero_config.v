...
//NOW with SRAM
//only quark moded has its own file in PROCESSOR
...
`define NRV_IO_LEDS          // Mapped IO, LEDs D2,D3,D4 (D5 is used to display errors) #will alias D2 for D5 because of error reporting nature SRAM HACKING TURNOFF
...
`define NRV_FEMTORV32_QUARK_SRAM  //if FEMTORV32_QUARK_SRAM defined must also define NRV_SRAM
`define NRV_SRAM //right now only for femtorv32_quark_sram.v
...
//next 3 lines because of testing sram bug
//`undef NRV_RUN_FROM_SPI_FLASH
//`undef NRV_RESET_ADDR
//`define NRV_RESET_ADDR 32'h00000000
