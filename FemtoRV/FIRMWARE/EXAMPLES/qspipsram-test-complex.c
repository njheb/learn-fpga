...
#define AVOID_SRAM_VARS_ZONE 655360 //640K

//uint32_t test_address = 0;
uint32_t test_address = 0+AVOID_SRAM_VARS_ZONE;
...
//   femtosoc_tty_init();
   while (1) {
      //blank 4MB
    printf("Blanking 4MB all except first 640k\n");
    for (int i=0+AVOID_SRAM_VARS_ZONE; i<65536*16*4; i+=4) PS_OUT(i,0x0);
